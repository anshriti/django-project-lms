...
from core.views import HomePageView, TeacherCreateView, TeacherListView, StudentCreateView,  StudentListView, TeacherDetailView, TeacherDeleteView, TeacherUpdateView
